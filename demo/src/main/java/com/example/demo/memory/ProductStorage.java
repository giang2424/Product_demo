...
public class ProductStorage {
    ...
    private void loadDataset() {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(
                ProductStorage.class.getResourceAsStream("products.data")
        ))) {
    ...
    public Product insertProduct(Product product) {
        ...
        addProductToStorage(product);
        // Save the dataset after inserting the product
        saveDataset();
    ...
    public Product updateProduct(Product product) {
        ...
        if (numChange == 0) {
            throw new RuntimeException("product code=[" + product.getCode() + "], no new value for update");
        }
        
        // Save the dataset after updating the product
        saveDataset();
    ...
    public Product deleteProductByCode(String code) {
        ...
        // Save the dataset after deleting the product
        saveDataset();
    ...
    private Path getFilePath(){
        ...
        return Paths.get(userHome,"Downloads", "demo", "demo", "src", "main", "java", "com", "example", "demo", "memory", "products.data");
